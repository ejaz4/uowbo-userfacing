  ...
  return (
    <div className="cardContainer">
      <Card>
        ...
        <p>
          During uowbo! verification, details such as IDs and email addresses
          are collected.
        </p>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            An image of your card - to analyse the authenticity of it in a
            secure environment, which is stored temporarily until an outcome.
          </li>
        </ul>
